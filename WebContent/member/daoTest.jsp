<%@page import="com.lec.sce.dto.MemberDto"%>
<%@page import="com.lec.sce.dao.MemberDao"%>
...
<%
	...
	if(MemberDao.EXISTENT == dao.midConfirm("bbb")){
		...
		int result = dao.joinMember(new MemberDto("bbb", "1", "이름", "test@naver.com", "010-9999-9999", null,"여", "서울"));
