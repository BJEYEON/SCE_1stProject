	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		// 파일첨부 로직 + 파라미터들 받아 DB에 join
				...
				try {
					...
					// mId, bTitle, bContent,  bimage, bIp
					...
					BoardDto boardDto = new BoardDto(0, mid, null, btitle, bcontent, null, bimage, 0, bgroup, bstep, bindent, bip);
				...
				if(bimage!=null && result == BoardDao.SUCCESS) {
					InputStream  is = null;
